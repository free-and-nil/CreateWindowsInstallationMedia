...
uses Windows, SysUtils,
	 TaskDlgApiU, MethodCallBackStubU;
...
{$ENDIF}
	...
	TTaskDlgButtons = class
	  private
        ...
        aButtonText : array of {$IFDEF UNICODE} String
	...
	TTaskDlg = class
	  private
		...
		FDefaultButton : TTaskDlgCommonButton;
...
//		function MakeProcInstance (M: TMethod) : Pointer;
	  ...
	  public
		...
		property DefaultButton : TTaskDlgCommonButton read FDefaultButton
